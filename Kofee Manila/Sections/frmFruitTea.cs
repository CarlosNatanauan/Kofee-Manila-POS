...
{
    public partial class frmFruitTea : Form
    {
        private MainForm MainForm { get; set; }
        private UC_FruitTea_Small ucSmall;
        private UC_FruitTea_Large ucLarge;

        public frmFruitTea(MainForm mainform)
        {
            InitializeComponent();
            this.MainForm = mainform;

            ucSmall = new UC_FruitTea_Small();
            ucSmall.OrderAdded += (o, args) => MainForm.AddOrders(args.ProductName, args.Quantity, args.Cost);
            ucLarge = new UC_FruitTea_Large();
